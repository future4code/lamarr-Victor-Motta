...
//     //tentativa de resortear as cartas caso elas fossem A

// if (usuarioCarta1 === 11) {usuarioCarta1 = comprarCarta()}
// else if(usuarioCarta2 ===11){usuarioCarta1=comprarCarta()}
// if (pcCarta1 === 11) {pcCarta1 = comprarCarta()}
// else if(pcCarta2 ===11){pcCarta2=comprarCarta()}
